...
public class Sortie_Intro_2 : MonoBehaviour
{
	...
	void Update ()
	{
		...
		regardperso = Perso.GetComponent<Controle_Personnage_Intro_2> ().regard;
		saut = Perso.GetComponent<Controle_Personnage_Intro_2> ().ensaut;
		chute = Perso.GetComponent<Controle_Personnage_Intro_2> ().enchute;
